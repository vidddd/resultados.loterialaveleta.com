<template>
  <div class="resultado resultado-quintupleplus">
    <div class="row">
      <div class="col-md-12">
        <div class="card">
            ...
            <div class="wrapper-fechas">
                    <div class="list-fechas">
                     <router-link v-for="(item, index) in sorteos" 
                                  :to="{ name: 'ResultadoQuintupleplus', params: { id: item.id }  }"
...
export default {
  ...
  mounted: function() {
    ...
    const vm = this
    fetch('https://loterialaveleta.com/sorteos/ultimossorteos/QUPL')
